        ...
        context 'client_ca_certs' do
          ...
          context 'are provided' do
            context 'when only_trust_client_ca_certs is true' do
              ...
              it 'sets trust_local_store_cas_for_clients to true' do
                expect(parsed_yaml['trust_local_store_cas_for_clients']).to equal(true)
              end
            end
            ...
            context 'when only_trust_client_ca_certs is false' do
              ...
              it 'sets trust_local_store_cas_for_clients to false' do
                expect(parsed_yaml['trust_local_store_cas_for_clients']).to equal(false)
              end
            end
          end
        end
